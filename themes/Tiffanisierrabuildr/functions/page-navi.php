<?php // Borrowed with love from FoundationPress
	function joints_page_navi() {
		...
		$paginate_links = paginate_links( array(
			...
			'mid_size' => 5,
			'prev_next' => true,
		    'prev_text' => __( '<i class="fa fa-arrow-circle-left" aria-hidden="true"></i></a></li>', 'jointswp' ),
		    'next_text' => __( '<i class="fa fa-arrow-circle-right aria-hidden="true"></i></a></li>', 'jointswp' ),
			'type' => 'list',
		) );
